...
class Better_Testimonial extends Widget_Base {
	...
	public function get_title() {
		return __( 'BETTER Testimonials', 'better-widgets' );
	}
	...
	protected function _register_controls() {
		...
		$this->add_control(
			...
			[
				'label' => esc_html__( 'Author Name', 'better-widgets' ),
		...
		$this->add_control(
			...
			[
				'label' => esc_html__( 'Author Designation', 'better-widgets' ),
				'type' => \Elementor\Controls_Manager::TEXT,
				'label_block' => true,
		...
		$this->add_control(
			...
			[
				'label' => esc_html__( 'Icon', 'better-widgets' ),
		...
		$this->add_control(
			...
			[
				'label' => esc_html__( 'Author', 'better-widgets' ),
				'type' => \Elementor\Controls_Manager::HEADING,
				'separator' => 'before',
			]
		);
		...
		$this->add_control(
			...
			[
				'label' => esc_html__( 'Designation Color', 'better-widgets' ),
				'type' => \Elementor\Controls_Manager::COLOR,
				'scheme' => [
				'type' => \Elementor\Scheme_Color::get_type(),
				'value' => \Elementor\Scheme_Color::COLOR_1,
		...
		$this->add_group_control(
			...
			[
				...
				'label' => esc_html__( 'Designation Typography', 'better-widgets' ),
				'scheme' => \Elementor\Scheme_Typography::TYPOGRAPHY_1,
