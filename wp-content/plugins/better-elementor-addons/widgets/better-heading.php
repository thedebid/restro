...
class Better_Heading extends Widget_Base {
	...
	protected function _register_controls() {
		...
		$this->add_control(
			...
			[
				'label' => esc_html__( 'Sub Title', 'better-widgets' ),
		...
		$this->add_control(
			...
			[
				'label' => esc_html__( 'Border 1 Color', 'better-widgets' ),
				'type' => \Elementor\Controls_Manager::COLOR,
				'scheme' => [
				'type' => \Elementor\Scheme_Color::get_type(),
				'value' => \Elementor\Scheme_Color::COLOR_1,
		...
		$this->add_control(
			...
			[
				'label' => esc_html__( 'Border 2 Color', 'better-widgets' ),
				'type' => \Elementor\Controls_Manager::COLOR,
				'scheme' => [
				'type' => \Elementor\Scheme_Color::get_type(),
				'value' => \Elementor\Scheme_Color::COLOR_1,
	...
	protected function render() {
       ...
       ?>
			<div class="better section-title">
