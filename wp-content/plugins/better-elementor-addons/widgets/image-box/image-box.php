...
class Better_Image_Box extends Widget_Base {
	...
	public function get_title() {
		return esc_html__( 'BETTER Image Box', 'better-widgets' );
	}
	...
	protected function _register_controls() {
		...
		$this->add_control(
			...
			[
				'label' => esc_html__( 'Number', 'better-widgets' ),
		...
		$this->add_control(
			...
			[
				'label' => esc_html__( 'Description', 'better-widgets' ),
...
//---------------------------------
		...
		$this->add_responsive_control(
			...
			[
				'label' => esc_html__( 'Alignment', 'better-widgets' ),
...
//---------------------------------
		...
		$this->add_group_control(
			...
			[
				...
				'selector' => '{{WRAPPER}} .single-image-box h2',
			]
		);
		...
		$this->add_responsive_control(
			...
			[
				...
				'size_units' => [ 'px', '%' ],
				'selectors' => [
					'{{WRAPPER}} .single-image-box h2' => 'margin: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
				],
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'selectors' => [
					'{{WRAPPER}} .single-image-box h2' => 'color: {{VALUE}}',
				],
			]
		);
		$this->add_control(
			...
			[
				...
				'selectors' => [
					'{{WRAPPER}} .single-image-box h2' => '-webkit-text-stroke-color: {{VALUE}}',
				],
			]
		);
		$this->add_control(
			...
			[
				...
				'size_units' => [ 'px', '%' ],
				'selectors' => [
					'{{WRAPPER}} .single-image-box h2' => '-webkit-text-stroke-width:{{SIZE}}{{UNIT}}',
				],
			]
		);
		...
		$this->add_control(
			'number_color_hover',
			[
				'label' => esc_html__( 'Number color','better-widgets' ),
				'type' => \Elementor\Controls_Manager::COLOR,
				'scheme' => [
				'type' => \Elementor\Scheme_Color::get_type(),
				...
				'selectors' => [
					'{{WRAPPER}} .single-image-box:hover h2' => 'color: {{VALUE}}',
				],
			]
		);
...
//--------------------------------------
		...
		$this->add_control(
			...
			[
				...
				'selectors' => [
					'{{WRAPPER}} .single-image-box h4' => 'color: {{VALUE}}',
				],
			]
		);
		$this->end_controls_tab();
		...
		$this->add_control(
			...
			[
				...
				'selectors' => [
					'{{WRAPPER}} .single-image-box:hover h4' => 'color: {{VALUE}}',
				],
			]
		);
		...
		$this->add_responsive_control(
			...
			[
				...
				'size_units' => [ 'px', '%' ],
				'selectors' => [
					'{{WRAPPER}} .single-image-box h4' => 'margin: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
				],
			]
		);
...
//----------------------------------------------
		...
		$this->add_control(
			...
			[
				...
				'selectors' => [
					'{{WRAPPER}} .single-image-box p' => 'color: {{VALUE}}',
				],
			]
		);
		$this->end_controls_tab();
		...
		$this->add_control(
			...
			[
				...
				'selectors' => [
					'{{WRAPPER}} .single-image-box:hover p' => 'color: {{VALUE}}',
				],
			]
		);
		...
		$this->add_responsive_control(
			...
			[
				...
				'size_units' => [ 'px', '%' ],
				'selectors' => [
					'{{WRAPPER}} .single-image-box p' => 'margin: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
				],
			]
		);
...
//----------------------------------------------------------------------------------------
		...
		$this->add_responsive_control(
			...
			[
				...
				'size_units' => [ 'px', '%' ],
				'selectors' => [
					'{{WRAPPER}} .single-image-box a' => 'margin: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
				],
			]
		);
		$this->add_responsive_control(
			...
			[
				...
				'size_units' => [ 'px', '%' ],
				'selectors' => [
					'{{WRAPPER}} .single-image-box a' => 'padding: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
				],
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'selectors' => [
					'{{WRAPPER}} .single-image-box a' => 'display: {{VALUE}};',
				],
			]
		);
		...
		$this->add_control(
			'btn_color_hover',
			[
				'label' => esc_html__( 'Button color','better-widgets' ),
				'type' => \Elementor\Controls_Manager::COLOR,
				'scheme' => [
				'type' => \Elementor\Scheme_Color::get_type(),
				'value' => \Elementor\Scheme_Color::COLOR_2,
				...
				'selectors' => [
					'{{WRAPPER}} .single-image-box:hover a' => 'color: {{VALUE}}',
				],
			]
		);
...
//----------------------------------------------------------------------------------------
		...
		$this->start_controls_section(
			'style_section',
			[
				'label' => esc_html__( 'Image Style', 'better-widgets' ),
		...
		$this->add_control(
			...
			[
				'label' => esc_html__( 'Image.', 'better-widgets' ),
		...
		$this->add_responsive_control(
			...
			[
				...
				'selectors' => [
					'{{WRAPPER}} .single-image-box img' => 'max-width: {{SIZE}}{{UNIT}};',
				],
			]
		);
	...
	protected function render() {
       ...
       ?>
			<div class="better single-image-box">
				<h2><?php echo $better_image_box_number;?></h2>
				<?php if ( $better_image_box_image){?>
				<img src="<?php echo $better_image_box_image;?>">
				<?php } ?>

				<h4><?php echo $better_image_box_title;?></h4>
				<p><?php echo $better_image_box_des;?></p>
