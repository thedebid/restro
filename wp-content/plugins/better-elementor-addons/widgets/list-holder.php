...
class Better_List_Holder extends Widget_Base {
	...
	//script depend
	public function get_script_depends() { return [ 'better-widgets']; }
	...
	protected function render() {
       ...
       ?>
			<div class="better-list-sider">
				<h4><?php echo $settings['better_list_holder_title'];?></h4>
				<div class="bea-related-dropdown">
					<div class="bea-related-btn">
						<span> <?php echo $settings['better_list_holder_btn'];?> </span>
					</div>
				</div>
				<div class="bea-purchase-btn">
							...
							<div class="bea-side-list-inner">
								...
								<a href="<?php echo  $item['link']['url']; ?>" target="_blank">
									<div class="item">
										...
										<span class="item-tag"> <?php echo  $item['tag']; ?></span>
